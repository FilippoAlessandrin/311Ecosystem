				...
				<div class="content-wrapper">
					<div class="row">
						<div class="col-md-12 grid-margin">
							<div class="d-flex justify-content-between align-items-center">
								<div>
									<h4 class="font-weight-bold mb-0">Bentornato, Guglielmo!</h4>
								</div>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-4 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<p class="card-title text-md-center text-xl-left">Visite al profilo</p>
						...
						<div class="col-md-4 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<p class="card-title text-md-center text-xl-left">Competenze in comune</p>
									<div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
						...
						<div class="col-md-4 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									<p class="card-title text-md-center text-xl-left">Numero di progetti</p>
									<div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
										<h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0">4</h3>
										<i class="ti-agenda icon-md text-muted mb-0 mb-md-3 mb-xl-0"></i>
									</div>  
									<p class="mb-0 mt-2 text-success">2 completati<span class="text-black ml-1"><small>(nell'ultimo mese)</small></span></p>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-12 grid-margin stretch-card">
							<div class="card position-relative">
								<div class="card-body">
									<p class="card-title m-0">Nuovi progetti</p>
												...
												<div class="row">
													<div class="col-9" style="height: auto;">
														<div class="mt-4 mb-4 ml-4">
															<h3 class="font-weight-light">Sviluppare una webapp</h3>
															<p class="text-muted mb-2 my-4 paragrafo-progetto" style="height: 60px; overflow: hidden;">Un progetto consiste, in senso generale, nell'organizzazione di azioni nel tempo per il perseguimento di uno scopo predefinito, attraverso le varie fasi di progettazione da parte di uno o più progettisti. Scopo finale è la realizzazione di un bene o servizio il cui ciclo di sviluppo è gestito tipicamente attraverso tecniche di project management.</p>
															<button type="button" class="btn btn-outline-info">Scopri di più</button>
														</div>
													</div>
													<div class="col-3">
														<div class="immagine-progetto"></div>
													</div>
												</div>
											</div>  
										</div>
					...
					<div class="row">
						<div class="col-md-12 grid-margin stretch-card">
							<div class="card position-relative">
								<div class="card-body">
									<p class="card-title">Le competenze in 311</p>
									<div class="row">
										<div class="col-md-12 col-xl-3 d-flex flex-column justify-content-center">
											<div class="ml-xl-4">
												<h1>33</h1>
												<h3 class="font-weight-light mb-xl-4">Competenze totali</h3>
												<p class="text-muted mb-2 mb-xl-0">Al 311 valorizziamo le competenze e bla bla bla bla</p>
											</div>  
										</div>
													...
													<div class="table-responsive mb-3 mb-md-0">
														<table class="table table-borderless report-table">
															<tr>
																...
																<td><h5 class="font-weight-bold mb-0">11</h5></td>
															</tr>
															<tr>
																<td class="text-muted">Internet Of Things</td>
																<td class="w-100 px-0">
																	<div class="progress progress-md mx-4">
															...
															<tr>
																...
																<td class="w-100 px-0">
																	<div class="progress progress-md mx-4">
																		<div class="progress-bar bg-primary" role="progressbar" style="width: 85%" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100"></div>
																	</div>
																</td>
																<td><h5 class="font-weight-bold mb-0">18</h5></td>
															</tr>
															<tr>
																<td class="text-muted">Machine learning</td>
																<td class="w-100 px-0">
																	<div class="progress progress-md mx-4">
																		<div class="progress-bar bg-primary" role="progressbar" style="width: 9%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
																	</div>
																</td>
																<td><h5 class="font-weight-bold mb-0">2</h5></td>
															</tr>
															<tr>
																<td class="text-muted">User Interface</td>
																<td class="w-100 px-0">
																	<div class="progress progress-md mx-4">
															...
															<tr>
																<td class="text-muted">Cyber Security</td>
																<td class="w-100 px-0">
																	<div class="progress progress-md mx-4">
																		<div class="progress-bar bg-primary" role="progressbar" style="width: 40%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
																	</div>
																</td>
